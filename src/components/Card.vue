...
<div class="card"
	...
	:style="{top: `calc(${positions[card.position].top}% - 4.5rem)`, left: `calc(${positions[card.position].left}% - ${ positionLeftGap - gapBetweenCards * card.positionIndex}rem)`, zIndex: card.positionIndex}">
